    ...
    render(){
        ...
        return(
            <div className='login'>
                ...
                <Button name={this.state.button.submit} click={this.submit} style={{marginLeft:'80px'}}/>
                <Button name={this.state.button.reset} click={this.reset} style={{marginLeft:'50px'}}/>
            </div>
        )
    }
